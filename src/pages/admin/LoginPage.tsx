  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <img
          src="https://images.unsplash.com/photo-1635870638245-2118ad572242?w=1200"
        ...
        <div className="absolute bottom-20 left-20 right-20 text-white z-10">
          <h2 className="text-5xl font-black mb-6 tracking-tighter leading-tight">
            MANAGE YOUR <br /> DIGITAL STORE.
          </h2>
          <p className="text-xl font-medium opacity-90">
            Professional dashboard for modern retailers. <br />
            Control inventory, track orders, and analyze growth.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-[450px]">
          <div className="bg-white p-8 md:p-12 rounded-[40px] shadow-2xl shadow-gray-200/50 border border-gray-100">
            <div className="text-center mb-10">
              ...
              <h1 className="text-4xl font-black text-gray-900 mb-3 tracking-tight">Admin Access</h1>
              <p className="text-gray-500 font-bold text-sm uppercase tracking-widest">Secure Dashboard</p>
            </div>
