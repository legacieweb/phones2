      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute bottom-20 left-20 right-20 text-white z-10">
          ...
          <p className="text-xl font-medium opacity-90">
            Create an account to unlock exclusive deals, <br />
            fast checkout, and premium support.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-[450px]">
          <div className="bg-white p-8 md:p-12 rounded-[40px] shadow-2xl shadow-gray-200/50 border border-gray-100">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 font-bold text-sm uppercase tracking-widest">Join PhoneStore</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 px-4 text-gray-900 focus:outline-none focus:ring-4 focus:ring-primary-100 focus:border-primary-600 transition-all font-medium"
                    placeholder="John"
                    required
                  />
                </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gray-900 hover:bg-primary-600 disabled:bg-gray-400 text-white font-black py-5 rounded-2xl transition-all shadow-xl shadow-gray-900/10 active:scale-[0.98] flex items-center justify-center gap-3 text-lg mt-4"
              >
                {loading ? (
